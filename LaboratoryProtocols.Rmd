...
**John M.A. Wojahn, Byron Crump**

**2013**

1. Wipe off any dry contaminants (e.g. mud, sand, silica gel dust) into trash.
2. Spray counter liberally with bleach cleaning solution (1X Sodium Hypochlorite; this destroys most of the DNA and RNA)
3. Let sit 30 seconds then wipe off the bleach solution with a clean paper towel.
4. Spray counter liberally with 70% ethanol solution (This kills any living organisms and also dries the counter faster).
3. Let sit 30 seconds then wipe off the ethanol solution with a clean paper towel.
4. OPTIONAL Spray counter with RNase decontamination solution (e.g. RNase Zap; this deactivates any remaining RNases on the counter, this is necessary if doing an RNA extraction).

# Sterilizing Laminar Flow Hood

**John M.A. Wojahn, Byron Crump**

**2013**

This protocol must be done both before and after using laminar flow hood.

1. Wipe off any dry contaminants (e.g. mud, sand, silica gel dust) into trash.
2. Spray hood counter liberally with bleach cleaning solution (1X Sodium Hypochlorite; this destroys most of the DNA and RNA)
3. Let sit 30 seconds then wipe off the bleach solution with a clean paper towel.
4. Spray counter liberally with 70% ethanol solution (This kills any living organisms and also dries the counter faster).
3. Let sit 30 seconds then wipe off the ethanol solution with a clean paper towel.
4. OPTIONAL Spray counter with RNase decontamination solution (e.g. RNase Zap; this deactivates any remaining RNases on the counter, this is necessary if doing an RNA extraction).
5. Turn on the ultraviolet sterilization lamp for 30 minutes (do not look at the lamp).

# Mortar and Pestle Extraction Protocol for Coriaceous and Thick Tropical Plant Leaf Tissue

**John M.A. Wojahn, Sven Buerki**
...
5. Preheat oscillating dry bath to 65 degrees C and max oscillations. Take off plastic lid by sliding it backwards
6. Write down sample information in notebook
7. Shake loose silica from sample packet
8. Using tweezers take out leaf strips and weigh out 0.2 g using weigh boat and scale.
Never use up all the sample, always leave at least a little material.
9. Place leaf material in sterile mortar and pestle
10. Pour in about 50 mL of liquid Nitrogen
11. Grind material until it is powdery, like matcha
12. Scrape material into 2 mL tube with spoontula or rubber policeman
...
15. Make sure you have ice available
16. Add 130 uL of reagent 3 to each tube, vortex, and immediately place tube in ice
rack.
17. Incubate tubes in ice for 5 minutes
...
24. Using same tip transfer ~600 uL mixture to white spin column and close it
...
31. Discard flow through and repeat steps 28 through 30
32. Transfer spin basket to empty collection tubes
33. Add 50 uL reagant 6 directly on membrane of spin basket
34. Incubate at room temperature for 5 minutes
35. Centrifuge tubes at 12,000 rpm for 5 minutes
36. Repeat steps 32, 33, and 34
37. Transfer 100 uL of eluate to 1.5 mL conical tube
37. Close tube and use NanoDrop to quantify DNA and assess purity
38. Place tubes in labeled rack in -20 freezer
39. Clean mortar and pestle and spoontula with bleach, rinse, then autoclave: just use bleach and ethanol on rubber policeman
40. Clean counter with bleach and ethanol




# Bead-Beating Extraction Protocol For Tropical and Temperate Plant Leaf Tissue
...
# How to use a Nanodrop Spectrophotometer

**John M.A. Wojahn and Sven Buerki**

**2017**

1. Plug in Nanodrop machine.
2. Choose "Nucleotides".
3. Lift arm and pipette 2 µL ultrapure water onto the pedestal (make sure it is centered and that the droplet is plump).
4. Lower arm.
5. Choose "DNA" or "RNA".
6. Lift arm and wipe off pedestal with dry kimwipe and then pipet 2 µL of blanking solution to pedestal (make sure it is centered and that the droplet is plump).
7. Lower arm.
8. Hit "Blank".
9. Lift arm and wipe off pedestal with dry kimwipe and then pipet 2 µL of sample solution to pedestal (make sure it is centered and that the droplet is plump).
10. Lower arm.
11. Hit "Measure".
12. Record values.
13. Lift arm and wipe off pedestal with dry kimwipe and repeat steps 9-12 for each sample.
14. When done pipette 2 µL ultrapure water onto the pedestal (make sure it is centered and that the droplet is plump).
15. Close and open arm and wipe off droplet with a dry kimwipe.
16. Unplug Nanodrop machine.
...
17.	Swirl beads
18.	Slowly pour out ethanol into container to evaporate without losing beads (you can use a sieve if you want)
...
BEFORE DOING ANYTHING: Write the order in which you want to load your samples into the notebook template (you can print it from the Templates section of this website if none are available in the lab) and then place your sample tubes in a 96-hole tube rack in that same order. MAKE SURE TO NOT ROTATE TUBE RACK OR PCR PLATE.

1. To each well, add the following reagents in the order below (you do not need to change tips between columns/cells except for when adding the template):

    * 12.5 µL Master Mix (e.g. AmpliTaq Gold 360)
    * 1 µL 1/10X forward primer
    * 1 µL 1/10X reverse primer
    * 8.5 µL ultrapure water
    * OPTIONAL 5 µL Mg 2+
    * 2 µL template

2. Cover tubes with caps and press down with finger.
3. Once all tubes are capped use the rubber roller to ensure they are all tight.
4. Spin down in plate spinner (USE BALANCE WEIGHT IF ONLY DOING 1 PLATE).
5. Place plate in PCR machine and tighten the lid (if too loose the caps will come off and there will be mixing and/or evaporative losses; if too tight the tubes could crack or the caps may invert causing mixing and/or evaporative losses).
6. PCR machines differ in how to input instructions into them, so the settings referenced here are generic.
7. Set the reaction volume (100 µL or 105 µL depending on whether Mg @+ was added).
8. Use heated lid.
9. Use the correct preset for your primers (e.g. ITS-WOJ or TRNL-WOJ)
10. Spin down in plate spinner (USE BALANCE WEIGHT IF ONLY DOING 1 PLATE).
11. Add plate to plate holder and plastic dome and label both the holder and base with the PCR number, your name, and date completed.
12. Place plate in -20 Freezer.
...
# Making 50X TAE Buffer Stock

**John. M. A. Wojahn, Byron C. Crump**
...
* 242 g tris base
* 700 mL ultrapure water + extra to get to 1 L final volume
* 57.1 mL glacial acetic acid (warning: smelly)
* 100 mL EDTA 0.5 M at pH 8

Recipe:

1. Add the tris base to a 2 L beaker.
2. Place a magnetic stir rod in the beaker.
3. Add the ultrapure water to the beaker.
4. Use a stirplate to FULLY dissolve the tris base in the water.
5. Add glacial acetic acid and EDTA to the beaker.
6. Add enough ultrapure water to get solution to approximately 1 L volume.
7. Stir for a couple more minutes to ensure homogeneity.
8. Pour solution into bottle and cap tightly.

# Making 1X TAE Buffer from 50X TAE Buffer Stock
...
1. Add 20 mL of 50X stock solution to receptacle container.
2. Add 980 mL of ultrapure water to receptacle container.
3. Mix thoroughly through shaking and inversion.
